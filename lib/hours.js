...
// El miércoles en que arranca la semana de pago que contiene `dayKey`
// ('YYYY-MM-DD'). La semana corre miércoles a martes. Varios sitios derivaban
// esto con su propia copia de `(getDay() + 4) % 7`; esta es la versión a la
// que deberían converger.
export function payWeekStart(dayKey) {
