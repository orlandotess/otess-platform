...
const PUBLIC_PATHS = ['/login', '/factura', '/estimado', '/propuesta', '/favicon.ico', '/otess-logo.png', '/api/send-invoice', '/api/send-estimate', '/api/recurring-invoices', '/api/invoice-reminders', '/api/calendar/feed', '/api/propuestas/aprobar'];
