...
const PUBLIC_PATHS = ['/login', '/forgot-password', '/reset-password', '/factura', '/estimado', '/propuesta', '/orden-cambio', '/reporte', '/reporte-boleto', '/reporte-mantenimiento', '/favicon.ico', '/otess-logo.png', '/otess-logo-blanco.png', '/api/login', '/api/forgot-password', '/api/send-invoice', '/api/send-estimate', '/api/send-report', '/api/send-ticket-report', '/api/recurring-invoices', '/api/recurring-expenses', '/api/recurring-maintenances', '/api/invoice-reminders', '/api/calendar-reminders', '/api/calendar/feed', '/api/propuestas/aprobar', '/api/ordenes-cambio/aprobar', '/api/paypal/create-order', '/api/paypal/capture-order', '/api/service-tickets/inbound'];
