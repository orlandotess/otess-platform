...
const PUBLIC_PATHS = ['/login', '/factura', '/propuesta', '/favicon.ico', '/otess-logo.png', '/api/send-invoice', '/api/recurring-invoices', '/api/invoice-reminders', '/api/calendar/feed', '/api/propuestas/aprobar'];
